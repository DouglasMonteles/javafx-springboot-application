...
public enum Routes {
    ...
    UPDATE_PRODUCT () {
        ...
        @Override
        protected FXMLLoader loadFxmlScreen() {
            var fxmlLoader = getResource("update_product_screen");
            fxmlLoader.setControllerFactory(controller -> RoutesController.productController);
        ...
        @Override
        public void apply() {
            screen.setTitle("Atualização de Produto")
                    .setWidth(600)
                    .setMaxWidth(600)
                    .setHeight(720)
                    .setMinWidth(200)
    ...
    INFO_PRODUCT () {
        ...
        @Override
        protected FXMLLoader loadFxmlScreen() {
            var fxmlLoader = getResource("info_product_screen");
            fxmlLoader.setControllerFactory(controller -> RoutesController.productController);
        ...
        @Override
        public void apply() {
            screen.setTitle("Informações do Produto")
                    .setWidth(600)
                    .setMaxWidth(600)
                    .setHeight(720)
                    .setMinWidth(200)
    ...
    INFO_ORDER () {
        ...
        @Override
        protected FXMLLoader loadFxmlScreen() {
            var fxmlLoader = getResource("info_order_screen");
            fxmlLoader.setControllerFactory(controller -> RoutesController.orderController);
        ...
        @Override
        public void apply() {
            screen.setTitle("Informações do Pedido")
                    .setWidth(600)
                    .setMaxWidth(600)
                    .setHeight(720)
                    .setMinWidth(200)
